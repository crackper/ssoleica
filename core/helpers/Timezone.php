...
namespace SSOLeica\Core\Helpers;
...
class Timezone {
    ...
    public static function toLocal($timestamp,$timezone,$format="Y-m-d H:i:s")
    {
        $carbon = new Carbon($timestamp,'UTC');
        $carbon->timezone = new \DateTimeZone($timezone);

        return $carbon->format($format);
    }

    public static function toUTC($timestamp,$timezone,$format="Y-m-d H:i:s")
    {
        $carbon = new Carbon($timestamp,$timezone);
     ...
     * @return DateTime
     */
    public static function addTime($fecha,$interval)
    {
        $fechaFin =    new \DateTime($fecha);

        return $fechaFin->add(new \DateInterval($interval));
    }
